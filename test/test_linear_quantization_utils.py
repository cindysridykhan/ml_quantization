import torch
from src.quantization.linear_quantization_utils import *
import pytest
...
class TestLinearQuantizationUtils(unittest.TestCase):
    ...
    @mock.patch('src.quantization.linear_quantization_utils.get_quantized_range', return_value=(-4, 3))
    ...
    @mock.patch('src.quantization.linear_quantization_utils.get_quantized_range', return_value=(-8, 7))
    ...
    @mock.patch('src.quantization.linear_quantization_utils.linear_quantize_tensor', return_value=None)
    @mock.patch(
            'src.quantization.linear_quantization_utils.get_absmax_quantization_scale_per_tensor',
            side_effect=[2, 2]
            )
